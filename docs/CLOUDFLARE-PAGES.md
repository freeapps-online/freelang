...
- Connect the private GitHub repository `languagua-app/languagua` to Cloudflare Pages.
...
- `pnpm cf:deploy` builds the app and deploys a production Pages release using the `languagua` project configured in `wrangler.jsonc`.
